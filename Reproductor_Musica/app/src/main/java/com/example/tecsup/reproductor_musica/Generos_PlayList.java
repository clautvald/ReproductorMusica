...
public class Generos_PlayList extends Fragment {
    RecyclerView recyclerView;
    GeneroPL_Adaptador adaptadorGenero;
    @Nullable
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generos__play_list);
    }*/
    ...
    private void ExtraerJSON(String urlspoty) {
        Response.Listener<String> response_listener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    JSONObject categoriasjs = new JSONObject(response).getJSONObject("playlists");
                    ...
                    for(int i=0;i<items.length();i++){
                        ...
                        JSONArray iconos =json_Generos.getJSONArray("images");
                        ...
                        adaptadorGenero = new GeneroPL_Adaptador(genero,getActivity());
